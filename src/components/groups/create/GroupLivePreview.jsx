...
const GroupLivePreview = ({ groupData }) => {
    ...
    // Derive tags from category or simple dummy logic
    const baseTags = groupData.category ? [`#${groupData.category.toLowerCase().replace(/\s+/g, '-')}`] : [];
    const tags = ['#interview-prep', '#case-studies', ...baseTags].slice(0, 3);

    return (
        <div className="sticky top-24 w-full max-w-md mx-auto xl:ml-auto">
            ...
            <div className="bg-bg-secondary border border-border-primary rounded-2xl overflow-hidden shadow-2xl relative">
                ...
                <div className="h-28 bg-gradient-to-br from-amber-600/40 via-orange-900/40 to-[#0f172a] relative">
                ...
                <div className="px-5 pb-5">
                    ...
                    <div className="relative -mt-8 mb-3 z-10">
                        <div className="w-16 h-16 rounded-xl bg-accent-blue border-[3px] border-bg-secondary flex items-center justify-center shadow-lg text-white font-black text-xl">
            ...
            <p className="text-center text-xs text-accent-blue mt-6 italic opacity-80 max-w-xs mx-auto">
...
export default GroupLivePreview;
